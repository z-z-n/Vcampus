...
public class SaleAdminiMainUI extends JFrame  {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SaleAdminiMainUI frame = new SaleAdminiMainUI("333191956","崔致远","33");
	 ...
	 * Create the frame.
	 */
	public SaleAdminiMainUI(String t1,String t2,String t3) {
		...
		PersonalPanel1.setBounds(24, 339, 212, 105);
		...
		Headseparator4.setBounds(266, 0, 2, 40);
		...
		Headseparator5.setBounds(377, 0, 2, 40);
		...
		inSwitchpanel.setBounds(41, 500, 226, 393);
		...
		inSwitchPanel1_4.setBackground(Color.WHITE);
		inSwitchPanel1_4.setBounds(29, 90, 140, 50);
		...
		ForMainPanel.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {//按压
				...
				ImageIcon images = new ImageIcon("picture\\5str.jpg");
				lblSwitchIconLabel1_4 = new JLabel(images);
				lblSwitchIconLabel1_4.setBounds(10, 10, 30, 30);
				inSwitchPanel1_4.add(lblSwitchIconLabel1_4);
		...
		ForStorePanel.setBounds(268, 1, 108, 40);
