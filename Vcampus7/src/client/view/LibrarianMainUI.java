...
public class LibrarianMainUI extends JFrame  {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					LibrarianMainUI frame = new LibrarianMainUI("323191956","崔致远","32");
	 ...
	 * Create the frame.
	 */
	public LibrarianMainUI(String t1,String t2,String t3) {
		...
		Headseparator3.setBounds(266, 0, 2, 40);
		...
		Headseparator4.setBounds(377, 0, 2, 40);
		...
		Headseparator5.setBounds(488, 0, 2, 40);
		...
		inSwitchPanel1_3.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				MainPanel = new LibManMainUI();//*****************************************************图书馆
				MainPanel.setBounds(259,50,1405,929);
		...
		inSwitchPanel1_3.setBackground(Color.WHITE);
		inSwitchPanel1_3.setBounds(29, 124, 140, 50);
		...
		inSwitchPanel1_4.setBackground(Color.WHITE);
		inSwitchPanel1_4.setBounds(29, 200, 140, 50);
		...
		ForMainPanel.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {//按压
				...
				ImageIcon images = new ImageIcon("picture\\4lib.jpg");
				lblSwitchIconLabel1_3 = new JLabel(images);
				lblSwitchIconLabel1_3.setBounds(10, 10, 30, 30);
				inSwitchPanel1_3.add(lblSwitchIconLabel1_3);
		...
		ForLibraryPanel.setBounds(268, 1, 108, 40);
		...
		ForStorePanel.setBounds(379, 1, 108, 40);
