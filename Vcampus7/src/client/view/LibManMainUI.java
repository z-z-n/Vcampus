...
public class LibManMainUI extends JPanel {
	int index = 0;
//	private static JPanel contentPane;
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					LibManMainUI frame = new LibManMainUI();
	...
	public LibManMainUI() {
		...
		paneLibrarymanage.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				//txtheader.setText(lbllendManager.getText());
				panelBigerMain.setVisible(false);
				panelBigerMain = new LibSearchPanel2();
		...
		lblLibraryMessage = new JLabel(" 书籍查询");
		...
		paneLendManage.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				//txtheader.setText(lbllendManager.getText());
				panelBigerMain.setVisible(false);
				panelBigerMain = new LibAddPanel();
				panelBigerMain.setBounds(286, 68, 1076, 623);
			    add(panelBigerMain);
				repaint();
		...
		lbllendManager = new JLabel(" 上架书籍");
		...
		panelUsermanage.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				//txtheader.setText(lbllendManager.getText());
				panelBigerMain.setVisible(false);
				panelBigerMain = new LibDelPanel();
				panelBigerMain.setBounds(286, 68, 1076, 623);
				add(panelBigerMain);
				repaint();
		...
		panelstatisticsManage.addMouseListener(new MouseAdapter() {
			...
			//	txtheader.setText(lbllendManager.getText());
				panelBigerMain.setVisible(false);
				panelBigerMain = new LibChangePanel();
				panelBigerMain.setBounds(286, 68, 1076, 623);
				add(panelBigerMain);
				repaint();
		...
		JLabel lblstatistics = new JLabel(" 修改书籍");
		...
		txtheader.setFont(new Font("华文行楷", Font.BOLD, 40));
