...
import client.service.SMgoodsManger;
...
public class SMMangerUI extends JPanel {
		...
		yigoumai.addMouseListener(new MouseAdapter() {
 			...
 			public void mouseClicked(MouseEvent e) {
               ...
               // search。setBorderPainted(false);//不绘制边框
                ...
                kaui1.addMouseListener(new MouseAdapter() {
        			...
        			public void mouseClicked(MouseEvent e) {
        				main.setVisible(false);
        				main = new SMsearch("1",kaui1.getText());
        				//main.setBounds(286, 68, 1076, 623);
        			    add(main);
        				repaint();
                ...
                kuai2.addMouseListener(new MouseAdapter() {
        			...
        			public void mouseClicked(MouseEvent e) {
        				main.setVisible(false);
        				main = new SMsearch("1",kuai2.getText());
        				//main.setBounds(286, 68, 1076, 623);
        			    add(main);
        				repaint();
                ...
                kuai3.addMouseListener(new MouseAdapter() {
        			...
        			public void mouseClicked(MouseEvent e) {
        				main.setVisible(false);
        				main = new SMsearch("1",kuai3.getText());
        				//main.setBounds(286, 68, 1076, 623);
        			    add(main);
        				repaint();
                ...
                kuai4.addMouseListener(new MouseAdapter() {
        			...
        			public void mouseClicked(MouseEvent e) {
        				main.setVisible(false);
        				main = new SMsearch("1",kuai4.getText());
        				//main.setBounds(286, 68, 1076, 623);
        			    add(main);
        				repaint();
                ...
                kuai5.addMouseListener(new MouseAdapter() {
        			...
        			public void mouseClicked(MouseEvent e) {
        				main.setVisible(false);
        				main = new SMsearch("1",kuai5.getText());
        				//main.setBounds(286, 68, 1076, 623);
        			    add(main);
        				repaint();
                ...
                kuai6.addMouseListener(new MouseAdapter() {
        			...
        			public void mouseClicked(MouseEvent e) {
        				main.setVisible(false);
        				main = new SMsearch("1",kuai6.getText());
        				//main.setBounds(286, 68, 1076, 623);
        			    add(main);
        				repaint();
    		...
    		table.addMouseListener( new MouseListener(){
	         ...
	         //   String info=r+"行"+c+"列结果 : "+value.toString();
	            main.setVisible(false);
				main = new SMgoodsUI("1",value.toString());
				//main.setBounds(286, 68, 1076, 623);
			    add(main);
				repaint();        
                ...
                JButton huanyipi = new JButton(huan);
                huanyipi.setBackground(Color.white);
                huanyipi.setContentAreaFilled(false);
                huanyipi.setBorderPainted(false);
                huanyipi.setBounds(1191, 742, 70, 70);
                main.add(huanyipi);
                
                JLabel lblNewLabel_1 = new JLabel("\u6362\u4E00\u6279");
                lblNewLabel_1.setHorizontalAlignment(SwingConstants.CENTER);
                lblNewLabel_1.setFont(new Font("微软雅黑", Font.PLAIN, 15));
                lblNewLabel_1.setForeground(Color.GRAY);
                lblNewLabel_1.setBounds(1191, 811, 70, 36);
                main.add(lblNewLabel_1);
                
                huanyipi.addMouseListener(new MouseAdapter() {
        			@Override
        			public void mouseEntered(MouseEvent e) {
                ...
                search.addMouseListener(new MouseAdapter() {////////////////////////////////实现搜索
         			...
         			public void mouseClicked(MouseEvent e) {
         				...
         				//六个六个的展示
         				main.setVisible(false);
        				main = new SMsearch("1",shangpingming);
