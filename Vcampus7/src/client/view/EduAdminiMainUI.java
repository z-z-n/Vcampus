...
public class EduAdminiMainUI extends JFrame  {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EduAdminiMainUI frame = new EduAdminiMainUI("313191956","崔致远","3");
	 ...
	 * Create the frame.
	 */
	public EduAdminiMainUI(String t1,String t2,String t3) {
        ...
        //ͷ������Ӧ
		ImageIcon images = new ImageIcon("picture\\administer.jpg");
		...
		inSwitchPanel2.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				MainPanel = new StManagerUI_Mg();//**********************************************学生管理
				MainPanel.setBounds(259,50,1405,929);
		...
		inSwitchPanel1_2.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				MainPanel.setVisible(false);
				MainPanel = new FunctionEduUI_Mg();//*************************************************教务
				MainPanel.setBounds(259,50,1405,929);
				contentPane.add(MainPanel);
				repaint();
			}
		...
		ForEducationPanel.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				MainPanel.setVisible(false);
				MainPanel = new FunctionEduUI_Mg();//*********************************************************教务服务
				MainPanel.setBounds(259,50,1405,929);
				contentPane.add(MainPanel);
				repaint();
			}
