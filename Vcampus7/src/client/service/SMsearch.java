...
public class SMsearch extends JPanel {
	 ...
	 * Create the panel.
	 */
	public SMsearch(String id,String name) {
		...
		car.addMouseListener(new MouseAdapter() {
 			...
 			public void mouseClicked(MouseEvent e) {
               ...
               // search。setBorderPainted(false);//不绘制边框
                ...
                UniversalClass obj = new UniversalClass(name);
	    		...
	    		sp.setSize(880, 640);
	     		...
	     		table.setDefaultRenderer(Object.class, new TableViewRenderer());//红色标记部分是用来渲染JTable的自定义绘制
	     		...
	     		table.addMouseListener( new MouseListener(){
	 	         ...
	 	         //   String info=r+"行"+c+"列结果 : "+value.toString();
	                 ...
	                 String shangpingming1=sousuo.getText();
	                 ...
	                 search.addMouseListener(new MouseAdapter() {////////////////////////////////实现搜索
	          			...
	          			public void mouseClicked(MouseEvent e) {
	         				//main.setBounds(286, 68, 1076, 623);
	          				...
	          				//六个六个的展示
	          				main.setVisible(false);
	         				main = new SMsearch(id,shangpingming1);
	         			    add(main);
	         				repaint();
	          			}
	          		});
